...
co::EVar64 alpha(co::EFloat64(0.1975),co::EFloat64(0.18),co::EFloat64(0.21));
...
co::EVar64 qq(co::EFloat64(6.675),co::EFloat64(6),co::EFloat64(7.5));
...
std::string dir ="/home/marvin/Documents/ug4/apps/epidemics_app_HE/parameteroptimization/";
...
solver.change_derivative_step_size(0.001); // variable
