...
\usepackage[backend=bibtex,style=alphabetic]{biblatex} % Use the bibtex backend with the alphabetic style
...
\thesistitle{Performance and variable optimization analysis of the SEIRD Epidemics model} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle	
...
\emph{Author:}\\
\href{marvin.glaser91@gmail.com}{\authorname} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisor:} \\
\href{wittum@techsim.org}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
...
I would like to express my gratitude to Professor Gabriel Wittum, who gave me the opportunity
to write this thesis and who provided me with help and insight throughout this work. I would also like to
thank Devansh Rastogi, who allowed me to continue his previous work, as well as Tristan Scheidemann and
Yannick Rosam, who helped me with interesting discussions and insights. Lastly I would like to
thank my friends and family, who supported me throughout the process of writing this thesis.
