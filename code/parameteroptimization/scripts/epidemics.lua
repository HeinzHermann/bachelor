...
local myPath = os.getenv("UG4_ROOT").."/apps/code/parameteroptimization"
...
--local v_alpha = 0.197630304390785	-- rate of infection
local v_kappa = 1.000000000000000	-- 0 <=  split sympthomatic/asympthomatic <= 1
local v_theta = 0.005000000000000	-- 0 <=  mortality <= 1
local v_qq = 6.67500068384405		-- incubation time/ time till symptom development (in days)
